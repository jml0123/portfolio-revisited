    ...
    <div>
      ...
      ></WriteUpHeader>
        ...
        <p>
            ...
            With the listening experience having both of those passive and active qualities, what would an interface for an XR music experience look like? And, since we're building on top of an existing art medium, how can we amplify the original intent behind the music?
        </p>
